...
def load_from_json(RM: Roommanagement, filename:str):
    try:
        ...
        with open(filename, "r", encoding = "utf-8") as json_file:
            ...
            #loop through customer and create corresponding object
            for raw_customer in raw_RM["_Roommanagement__customers"]:
                    #buffer data in name and mail variable
            ...
            #loop through ech room in the rooms_data
            for raw_room in raw_RM["_Roommanagement__rooms"]:
                #buffer same attribute for each room
                room_number = raw_room["_Raum__room_number"]
                capacity = raw_room["_Raum__capacity"]
                
                #differentiate between the rooms and create the corresponding room
